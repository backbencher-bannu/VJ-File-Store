...
DB_URI = environ.get("DB_URI", "mongodb+srv://harishkumargorinta:P6ak9kZKvx33Jx3@movies24.ng58m.mongodb.net/?retryWrites=true&w=majority&appName=Movies24")
DB_NAME = environ.get("DB_NAME", "Movies24")
